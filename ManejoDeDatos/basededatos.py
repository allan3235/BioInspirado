...
class Modelo(Base):
    ...
    formato: Mapped[Optional[str]] = mapped_column(String(10))  # h5 / pth / savedmodel
    fecha: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class ImagenUso(Base):
    ...
    uso: Mapped[str] = mapped_column(String(50), nullable=False)  # entrenar / validar / probar
...
def obtener_sesion() -> Session:
    """Retorna una sesion activa para hacer queries."""
