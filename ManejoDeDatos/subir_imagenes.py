...
import os
from basededatos import Imagen, ImagenUso, iniciar_bd, obtener_sesion

DATASET_FLAT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "dataset", "oral-diseases-flat")
    ...
    for split, uso in USO_MAP.items():
        ...
        for enfermedad in os.listdir(split_dir):
            ...
            for archivo in archivos:
                ...
                sesion.add(imagen)
                sesion.flush()  # obtiene el id generado
